...
\abstract{\textbf{Summary:} The ease with which phylogenomic data can be generated has drastically escalated the computational burden for even routine phylogenetic investigations. To address this, we present \texttt{phyx}: a collection of programs written in C++ to explore, manipulate, analyze, and simulate phylogenetic objects (alignments, trees, and MCMC logs). Modelled after Unix/GNU/Linux command line tools, individual programs perform a single task and operate on standard I/O streams that can be piped to quickly and easily form complex analytical pipelines. Because of the stream-centric paradigm, memory requirements are minimized \textcolor{red}{(often only a single tree or sequence in memory at any instance)}, and hence \texttt{phyx} is capable of efficiently processing very large data sets.\\
\textbf{Availability and Implementation:} \texttt{phyx} runs on POSIX-compliant operating systems. Source code, installation instructions, documentation, and example files are freely available under the GNU General Public License at \href{https://github.com/FePhyFoFum/phyx}{https://github.com/FePhyFoFum/phyx}\\
...
% removing these non-essential references for space purposes
%, \texttt{PAL2NAL} \citep{Suyama2006}, and \texttt{SequenceMatrix} \citep{Vaidya2011})
