 ...
 */
double nw(Sequence & iseq1, Sequence & iseq2, map<char, map<char,int> > & scoringmatrix, double gap_penalty,
 ...
 * scoringmatrix should come from read_score_matrix
 */
double sw(Sequence & iseq1, Sequence & iseq2, map<char, map<char,int> > & scoringmatrix, double gap_penalty,
        string & aln1, string & aln2){
    string seq1 = iseq1.get_sequence();
    std::transform(seq1.begin(), seq1.end(),seq1.begin(), ::toupper); 
    string seq2 = iseq2.get_sequence();
